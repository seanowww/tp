...
public class JsonAdaptedPersonTest {
    ...
    private static final int VALID_YEAROFSTUDY = BENSON.getYearOfStudy();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_YEAROFSTUDY, VALID_FACULTY, VALID_ADDRESS, VALID_TAGS, false, 0);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_YEAROFSTUDY, VALID_FACULTY, INVALID_ADDRESS, VALID_TAGS, false, 0);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_YEAROFSTUDY, VALID_FACULTY, null, VALID_TAGS, false, 0);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_YEAROFSTUDY, VALID_FACULTY, VALID_ADDRESS, invalidTags, false, 0);
