...
public class CommandTestUtil {
    ...
    public static final String INVALID_YEAROFSTUDY_DESC = " " + PREFIX_YEAROFSTUDY + "6"; // year of study > 5
    public static final String INVALID_FACULTY_DESC = " " + PREFIX_FACULTY + " "; // empty faculty
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        ClubTrack expectedClubTrack = new ClubTrack(actualModel.getClubTrack());
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPersonList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedClubTrack, actualModel.getClubTrack());
